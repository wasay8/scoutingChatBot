...
export default class Dialogue extends Component {
    componentDidMount() {
        if (this.messagesEnd) {
            const scrollHeight = this.messagesEnd.scrollHeight;//height of div
            const height = this.messagesEnd.clientHeight;  //webset visable height  
    ...
    showImg = (src) => {
        return () => {
            ...
            newWin.document.title = 'Image Show'
